...
\title{Divide and Conquer the EmpiRE:\\ A Community-Maintainable Knowledge Graph of Empirical Research in Requirements Engineering
}

% 4. Annotate authors of the paper using the command \metaauthor{}
\author{Oliver Karras \and Felix Wernlein \and Jil Klünder \and Sören Auer}
