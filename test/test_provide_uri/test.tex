...
\addmetaproperty[ex, http://www.example.org/]{example}
\addmetaproperty[ex2, http://www.other-example.org/]{example}
\addmetaproperty[amo, http://purl.org/spar/amo/]{has_claim}
\addmetaproperty[owl, http://www.w3.org/2002/07/owl#]{sameAs}
\addmetaproperty[orkg_property, http://orkg.org/property/]{P69003}
\addmetaproperty[orkg_property, http://orkg.org/property/]{Modality}


\begin{document}
\section{Our research}
\contribution{Modality}{a new modality definition}
\contribution{P69003}{old modality definition suppressing warning}
...
\contribution{example}{This is an example.}
...
\contribution{ex:example}{this is another example.}
\contribution*{ex2:example}{this is yet another example.}
\contribution{ex2:example}{this is yet another other example.}
\contribution{amo:has_claim}{the earth is round.}
\contribution*{owl:sameAs}{\uri{https://www.wikidata.org/wiki/Q2}}
\end{document}