...
\addmetaproperty{example}
\addmetaproperty{example II}

% ambiguous command
\addmetaproperty{section}


\begin{document}
\contribution{section}{Our research}
\contribution{example II}{This another example.}
...
\addmetaproperty{example*+?/III}
\contribution{example*+?/III}{This another example.}
