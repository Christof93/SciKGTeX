...
% no namespace
\addmetaproperty[http://www.example.org]{exampleI}
% wrong uri (not resolvable)
\addmetaproperty[ex, example]{exampleII}
% too many arguments
\addmetaproperty[ex, http://www.example.org, ex2]{exampleIII} 

\begin{document}
\section{Our research}

\contribution{exampleI}{This is an example.}
...
\contribution{exampleII}{This is another example.}
...
\contribution{exampleIII}{This is another example.}
