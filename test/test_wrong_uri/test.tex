...
% no namespace
\addmetaproperty[http://www.example.org]{ORKGexampleI}
% wrong uri (not resolvable)
\addmetaproperty[ex, example]{ORKGexampleII}
% too many arguments
\addmetaproperty[ex, http://www.example.org, ex2]{ORKGexampleIII} 

\begin{document}
\section{Our research}

\ORKGexampleI{This is an example.}
...
\ORKGexampleII{This is another example.}
...
\ORKGexampleIII{This is another example.}
