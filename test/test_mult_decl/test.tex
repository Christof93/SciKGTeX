...
\usepackage{scikgtex}
\newpropertycommand[new, http://www.new-uri.org]{researchproblem}
\newpropertycommand{result}
\addmetaproperty{method}
\addmetaproperty[new, http://www.new-uri.org]{objective}
\addmetaproperty[orkg_property, http://orkg.org/property]{custom_contribution_type}
\addmetaproperty[orkg_property, http://orkg.org/property/]{P9008}

\begin{document}
\section{Our research}
\contribution{unknown_contribution_type}{Some type of info}
\contribution{custom_contribution_type}{Some type of info}
\contribution{P9008}{0.5}
\objective{This is the objective of our research.}
