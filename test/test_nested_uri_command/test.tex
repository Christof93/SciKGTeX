...
\usepackage{scikgtex}
\addmetaproperty[oeo, http://openenergy-platform.org/ontology/oeo/]{OEO_00000425}


\begin{document}
\section{Our research}

\researchproblem{We present an ...\background{\uri{https://acade...}{Requirement Engineering (RE)}}.}
...
\method{These are the methods of our research. We used a \contribution{oeo:OEO_00000425}{\uri{https://openenergy-platform.org/ontology/oeo/BFO_0000002}{wind turbine}.}}
...
\method{We evaluate ... 1680 user stories.}
improve the accuracy of the predictions, ca. \contribution{accuracy improvement}{10\%.}
}
