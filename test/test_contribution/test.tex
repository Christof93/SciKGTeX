...
The main experiment was accepted with p-value of \contribution{p-value}{0.05}.
Another experiment was rejected with a p-value of \contribution[2]{p-value}{0.4}.
With parameters so and so the hypothesis was even stronger. \contribution*[3]{p   
value}{0.01}
\end{document}